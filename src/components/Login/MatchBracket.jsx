...
const efra = [
  ...
  },
  {
    ...
    tournamentRoundText: "Round 1",
    participants: [
      { id: "team3", resultText: "1", isWinner: false, name: "Team C" },
      { id: "team4", resultText: "4", isWinner: true, name: "Team D" },
    ],
  },
  {
    id: 3,
    ...
    participants: [
      { id: "team2", resultText: "1", isWinner: false, name: "Team B" },
      { id: "team4", resultText: "2", isWinner: true, name: "Team D" },
    ],
  },
];
const MyMatch = React.memo((props) => {
  // console.log(props);
  const { participants, isWinner } = props.match;
  // Verificar si hay participantes
  if (!participants || participants.length < 2) {
    return <Typography variant="body2" color="error.main">Invalid match data</Typography>;
  }
      ...
      <CardContent>
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between'}}>
          <Typography variant="body2">
            {participants[0]?.resultText}
          </Typography>
          <Typography variant="body2">
            {participants[1]?.resultText}
          </Typography>
        </Box>
...
export default function MatchBracket(props) {
  const {matches} = props;
  ...
  return (
    <SingleEliminationBracket
      ...
      // svgWrapper={({ children }) => (
      //   <Box sx={{ overflowX: "auto", maxWidth: "100%" }}>{children}</Box>
      // )}
    />
  );
}
